<template>
    <div>
        <el-table :data="this.rows" border style="width: 100%">
            ...
            <el-table-column prop="CarrierNo" label="承运商编号"></el-table-column>
            <el-table-column prop="CarrierName" label="承运商名称"></el-table-column>
            <el-table-column prop="Tel" label="电话"></el-table-column>
            <el-table-column prop="Email" label="邮箱"></el-table-column>
            <el-table-column prop="CarrierPerson" label="联系人"></el-table-column>
            <el-table-column prop="CarrierLevel" label="等级"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        handleEdit(index, row) {
            // 触发编辑承运商事件，传递当前行数据
            this.$emit('editCarrier', row);
        },
        handleDelete(index, row) {
            // 触发删除承运商事件，传递当前行数据
            this.$emit('deleteCarrier', row);
        },
